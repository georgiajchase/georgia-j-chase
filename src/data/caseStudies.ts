...
export const caseStudies: CaseStudy[] = [
  {
    ...
    challenge: [
      "Northbridge Apparel had invested heavily in product photography and paid ads, but their organic search performance was almost almost nothing. Despite a beautiful storefront, they sat on page 5 of Google for every commercial keyword that mattered to their buyers.",
