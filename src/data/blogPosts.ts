...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "<h2 class='font-heading font-bold text-2xl text-foreground mt-8 mb-3'>Weeks 1–2: Fix the Technical Foundation</h2>",
      ...
      "<h2 class='font-heading font-bold text-2xl text-foreground mt-8 mb-3'>Weeks 3–4: Rewrite Your Money Pages</h2>",
